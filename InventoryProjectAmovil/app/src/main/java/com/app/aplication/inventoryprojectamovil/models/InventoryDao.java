...
public class InventoryDao extends AbstractDao<Inventory, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Registration_date = new Property(2, String.class, "registration_date", false, "REGISTRATION_DATE");
        public final static Property Units = new Property(3, Integer.class, "units", false, "UNITS");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"INVENTORY\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"REGISTRATION_DATE\" TEXT," + // 2: registration_date
                "\"UNITS\" INTEGER);"); // 3: units
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Inventory entity) {
        ...
        String registration_date = entity.getRegistration_date();
        if (registration_date != null) {
            stmt.bindString(3, registration_date);
        }
 
        Integer units = entity.getUnits();
        if (units != null) {
            stmt.bindLong(4, units);
        }
    }
    ...
    public Inventory readEntity(Cursor cursor, int offset) {
        Inventory entity = new Inventory( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // registration_date
            cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3) // units
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Inventory entity, int offset) {
        ...
        entity.setRegistration_date(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setUnits(cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3));
     }
